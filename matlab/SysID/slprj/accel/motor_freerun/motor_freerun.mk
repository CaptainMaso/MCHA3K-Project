...
MODEL              = motor_freerun
MODULES            = motor_freerun_acc_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c 
MAKEFILE           = motor_freerun.mk
MATLAB_ROOT        = C:/Program Files/MATLAB/R2016a
ALT_MATLAB_ROOT    = C:/PROGRA~1/MATLAB/R2016a
MASTER_ANCHOR_DIR  = 
START_DIR          = C:/Users/masom/OneDrive/Documents/Uni/MCHA3000/Project/matlab/SysID
MATLAB_BIN         = C:/Program Files/MATLAB/R2016a/bin
ALT_MATLAB_BIN     = C:/PROGRA~1/MATLAB/R2016a/bin
S_FUNCTIONS        =  QueryInstrument.c SendInstrument.c
S_FUNCTIONS_LIB    = 
SOLVER             = 
NUMST              = 2
TID01EQ            = 1
...
MEX_OPT_FILE       = -f C:/PROGRA~1/MATLAB/R2016a/rtw/c/tools/LCC-WI~1.XML
OPTIMIZATION_FLAGS = -DNDEBUG
ADDITIONAL_LDFLAGS = 
DEFINES_CUSTOM     = 

#--------------------------- Model and reference models -----------------------
MODELLIB                  = motor_freerunlib.lib
MODELREF_LINK_LIBS        = 
MODELREF_INC_PATH         = 
...
ADD_INCLUDES = \
	-I$(START_DIR)/slprj/accel/motor_freerun \
	-I$(START_DIR) \
...
LIBS += $(LIBUT) $(LIBMWMATHUTIL) $(LIBMWSL_FILEIO) $(LIBMWSL_IOFILE) $(LIBMWIPP) $(LIBMX) $(LIBMEX) $(LIBMWSIGSTREAM) $(LIBMWSL_ASYNCIO) $(LIBMWSLEXEC_SIMBRIDGE) $(LIBMWSIMULINK)
