...
for i = 2:size(theta, 1)
    ...
    [Theta_k(i), dTheta_k(i), Bias_k(i), P_k(:,:,i)] = IMUKalmanFilter(Theta_k(i-1), dTheta_k(i-1), Bias_k(i-1), P_k(:,:,i-1), gy(i - 1)*1.065264436e-3, yt, qw_hat, qb_hat, rw_hat, rt_hat);
end

%%
figure;
subplot(3,1,1);
plot(t, theta*180/pi, 'b', t, Theta_k*180/pi, 'r');
grid on;
subplot(3,1,2);
plot(t, dtheta*180/pi, 'b', t, dTheta_k*180/pi, 'r');
grid on;
subplot(3,1,3);
